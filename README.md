...
From-scratch implementation of Denoising Diffusion Probabilistic Model (DDPM) on MNIST dataset in <180 lines. Educational and inspired by other minimal implemenations like Andrej Karpathy's `microgpt`.
